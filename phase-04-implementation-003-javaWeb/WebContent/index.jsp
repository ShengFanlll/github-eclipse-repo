...
<body class="background1">
	...
	<div id="poem-txt"
		style="display: none; font-size: 18px; color: white; position:absolute; left :600px;top:20px" >
	...
	<img src="/static/imgs/earth.png"
		...
		title="点击后，开始流浪 ！"
		/>
	<div id="moviebox" style="margin-top: 120px; display: none"
		align="center">
		<video id="movie" height="600px" controls="controls"
			src="/static/video/movie.mp4" onended="onVideoEnd();" />
	</div>
	<div id="hornor" style="display:none;position:absolute;left:30px; bottom:10px;color:white;font-size:24px" align="center">
	2019年发生了很多大事，谨以此向<span style="color:red">《流浪地球》</span>和<span style="color:orange">华为公司</span>表示致敬 !  
	<br/>本网页未来将放在以下网站 sdlc.huaku-2019.xyz (华为公司的云服务器) <br/> huaku-2019, 2019 年，《流浪地球》 和华为很酷！ <br/>
	也许华为的崛起意味着，在人类未来需要流浪地球时，东方大国将作出巨大的贡献 ！</div>
</body>
</html>